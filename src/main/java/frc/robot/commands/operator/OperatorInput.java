...
public class OperatorInput {
  ...
  public OperatorInput(
      int driverControllerPort, int operatorControllerPort, SwerveSubsystem swerve) {
    this.swerve = swerve;
  ...
  public void configureBindings(SwerveSubsystem driveSubsystem) {
    ...
    new Trigger(() -> isY())
        .onTrue(new SetPoseCommand(swerve, new Pose2d(7.6, 6.00, Rotation2d.fromDegrees(0))));
  }
