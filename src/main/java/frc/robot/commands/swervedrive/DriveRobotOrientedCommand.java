...
public class DriveRobotOrientedCommand extends BaseDriveCommand {
     ...
     */
    public DriveRobotOrientedCommand(SwerveSubsystem swerve, Translation2d robotRelativeTranslation, Rotation2d robotRelativeHeading) {
        super(swerve);
    ...
    public void initialize() {
        logCommandStart("robotRelativeTranslation: " + robotRelativeTranslation + " robotRelativeHeading: " + robotRelativeHeading);
