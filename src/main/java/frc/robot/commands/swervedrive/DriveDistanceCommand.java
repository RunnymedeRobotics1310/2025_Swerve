...
public class DriveDistanceCommand extends BaseDriveCommand {
    ...
    public DriveDistanceCommand(SwerveSubsystem swerve, Translation2d velocityVectorMps, Rotation2d heading, double distanceMetres) {
        super(swerve);
    ...
    public void initialize() {
        logCommandStart("Velocity: " + velocityVectorMps + " headingSetpoint: " + headingSetpoint + " distance: " + distanceMetres + "m");
